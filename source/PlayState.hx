...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch(SONG.stage)
		{
			...
			case 'temple':
			{
					defaultCamZoom = 0.6;
						curStage = 'temple';
						var bg:FlxSprite = new FlxSprite(-700, -400).loadGraphic(Paths.image('linkstage/stage'));
						bg.antialiasing = true;
	...
	{
		if (!loadRep)
			trace('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
		else
		{
